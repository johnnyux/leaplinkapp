            ...
            <div class="modal-body">
                <form name="create_biolink_twitter_tweet" method="post" role="form">
                    ...
                    <div class="form-group">
                        <label for="twitter_tweet_location_url"><i class="fas fa-fw fa-link fa-sm text-muted mr-1"></i> <?= l('create_biolink_twitter_tweet_modal.location_url') ?></label>
                        <input id="twitter_tweet_location_url" type="url" class="form-control" name="location_url" required="required" maxlength="2048" placeholder="<?= l('create_biolink_twitter_tweet_modal.location_url_placeholder') ?>" />
                    </div>

                    <div class="form-group">
                        <label for="twitter_tweet_theme"><i class="fas fa-fw fa-sun fa-sm text-muted mr-1"></i> <?= l('create_biolink_twitter_tweet_modal.theme') ?></label>
