...
<form name="update_biolink_" method="post" role="form">
    ...
    <div class="form-group">
        ...
        <?php if(!empty($row->settings->file)): ?>
            <div>
                <small class="text-muted" id="file_name"><?= $row->settings->file ?></small>
                <a href="<?= \Altum\Uploads::get_full_url('files') . $row->settings->file ?>" id="file_url" class="small" target="_blank" data-toggle="tooltip" title="<?= l('global.view') ?>"><i class="fas fa-fw fa-xs fa-external-link-alt ml-1"></i></a>
            </div>
        <?php endif ?>
