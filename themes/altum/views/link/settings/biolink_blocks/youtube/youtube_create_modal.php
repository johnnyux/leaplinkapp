            ...
            <div class="modal-body">
                <form name="create_biolink_youtube" method="post" role="form">
                    ...
                    <div class="form-group">
                        <label for="youtube_location_url"><i class="fas fa-fw fa-link fa-sm text-muted mr-1"></i> <?= l('create_biolink_youtube_modal.location_url') ?></label>
                        <input id="youtube_location_url" type="url" class="form-control" name="location_url" required="required" maxlength="2048" placeholder="<?= l('create_biolink_youtube_modal.location_url_placeholder') ?>" />
                    </div>
