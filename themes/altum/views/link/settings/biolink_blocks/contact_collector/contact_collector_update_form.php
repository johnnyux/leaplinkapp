...
<form name="update_biolink_" method="post" role="form">
    ...
    <div class="collapse" id="<?= 'contact_collector_settings_container_' . $row->biolink_block_id ?>">
        ...
        <div class="form-group custom-control custom-switch">
            ...
            >
            <label class="custom-control-label clickable" for="<?= 'contact_collector_show_agreement_' . $row->biolink_block_id ?>"><?= l('create_biolink_contact_collector_modal.show_agreement') ?></label>
