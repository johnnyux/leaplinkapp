            ...
            <div class="modal-body">
                <form name="create_biolink_twitter_profile" method="post" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <input id="twitter_profile_location_url" type="url" class="form-control" name="location_url" required="required" maxlength="2048" placeholder="<?= l('create_biolink_twitter_profile_modal.location_url_placeholder') ?>" />
                    </div>
