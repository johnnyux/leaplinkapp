    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h5 class="modal-title"><?= l('create_biolink_telegram_modal.header') ?></h5>
            ...
            <div class="modal-body">
                <form name="create_biolink_telegram" method="post" role="form">
                    ...
                    <div class="form-group">
                        <label for="telegram_location_url"><i class="fas fa-fw fa-play fa-sm text-muted mr-1"></i> <?= l('create_biolink_telegram_modal.location_url') ?></label>
                        <input id="telegram_location_url" type="url" class="form-control" name="location_url" placeholder="<?= l('create_biolink_telegram_modal.location_url_placeholder') ?>" required="required" />
                    </div>
