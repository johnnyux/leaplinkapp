            ...
            <div class="d-flex align-items-center col-auto p-0">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right d-print-none">
                        ...
                        <a href="<?= url($data->url . '/statistics?type=' . $data->type . '&referrer_host=' . $data->referrer_host . '&start_date=' . $data->datetime['start_date'] . '&end_date=' . $data->datetime['end_date'] . '&export=json') ?>" target="_blank" class="dropdown-item">
