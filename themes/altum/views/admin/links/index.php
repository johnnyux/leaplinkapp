                ...
                <td class="text-nowrap">
                    <div class="d-flex flex-column">
                        ...
                        <div class="text-muted">
                            ...
                            <span title="<?= remove_url_protocol_from_url($row->location_url) ?>" class="text-muted align-middle"><?= string_truncate(remove_url_protocol_from_url($row->location_url), 32) ?></span>
